...
sparcs = function(){
    ...
    if(window['mathbiol']&&cmdSide){
        let h = '<p><span style="color:maroon">Published report:</span> Almeida JS, J Hajagos, J Saltz J, M Saltz (2019) <b>Serverless OpenHealth at data commons scale—traversing the 20 million patient records of New York’s SPARCS dataset in real-time</b>. PeerJ 7:e6230 <a href="https://doi.org/10.7717/peerj.6230" target="_blank" style="background-color:yellow">doi.org/10.7717/peerj.6230</a></p><p><b style="color:maroon;font-size:large">SPARCS</b>: New York Statewide Planning and Research Cooperative System (<a href="https://www.health.ny.gov/statistics/sparcs/" target="_blank">SPARCS</a>) Inpatient De-Identified dataset </p>'
